...
import { codexAuthStatus, codexSpawnTarget, findCodexBinary } from "./codex-binary.mjs";
...
if (codex && catalogOk) {
  try {
    const { command, options } = codexSpawnTarget(codex);
    const parsed = JSON.parse(
      execFileSync(command, ["debug", "models"], {
        ...options,
        encoding: "utf8",
        timeout: 30_000,
